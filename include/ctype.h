...
#define isalnum(c)  (_Ctype[c] & 0x1c)
#define isalpha(c)  (_Ctype[c] & 0x0c)
#define isblank(c)  (_Ctype[c] & 0x40)
#define iscntrl(c)  (_Ctype[c] & 0x80)
#define isdigit(c) ((_Ctype[c] & 0x1c) == 0x10)
#define isgraph(c) ((_Ctype[c] & 0x60) == 0x20)
#define islower(c) ((_Ctype[c] & 0x0c) == 0x04)
#define isprint(c)  (_Ctype[c] & 0x20)
#define ispunct(c)  (_Ctype[c] == 0x20)
#define isspace(c)  (_Ctype[c] & 0xc0)
#define isupper(c) ((_Ctype[c] & 0x0c) == 0x08)
#define isxdigit(c) (_Ctype[c] & 0x10)
